...
| <img src="https://github.com/HWANGDEOK.png" width="80"> | **HWANGDEOK** | •보안 및 인증 시스템 설계(OAuth 2.0 & JWT)<br>•접근 제어 및 데이터 검증 (Security & Valid)<br>•결제 시스템 구축 및 상태 관리 (PortOne API)| `스택 입력` | [![GitHub](https://img.shields.io/badge/GitHub-Link-181717?logo=github)](https://github.com/HWANGDEOK) |
