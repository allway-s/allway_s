...
| <img src="https://github.com/HWANGDEOK.png" width="80"> | **HWANGDEOK** | • OAuth2(네이버, 구글) 연동 및 JWT 기반 인증/인가 구현<br>• Spring Security 필터 체인 구성 및 접근 제어 설계<br>• 결제 위변조 방지를 위한 PortOne V2 백엔드 검증 로직 구현| `스택 입력` | [![GitHub](https://img.shields.io/badge/GitHub-Link-181717?logo=github)](https://github.com/HWANGDEOK) |
